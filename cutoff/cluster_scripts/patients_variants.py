'''
Get patients and variants information for further analysis
Note that this script has many overlaping code with patient_map.py
...
def main(**kwargs):
    ...
    for gene_range in gene_ranges:
        ...
        if kwargs['remove_nc'] and gene_range['chrom'] != last_chrom:
            coding_variant_file = '/cluster/project8/vyp/JingYu/git/phenopolis_analysis/data/public/vcf/chr{}.coding.tsv'.format(gene_range['chrom'])
...
if __name__ == '__main__':
    ...
    args = dict(
        ...
        cadd_file = '/SAN/vyplab/UCLex/mainset_November2017'+
                '/mainset_November2017_VEP/CADD.vcf.gz',
        vcf_file = '/SAN/vyplab/UCLex/mainset_November2017'+
                '/mainset_November2017_chr{}_filtered.vcf.gz',
        gnomad_path = '/cluster/project8/vyp/gnomad_data',
        uclex_genes_json = '/cluster/project8/vyp/JingYu/git/phenopolis_analysis/tests/data/uclex-genes.json',
        ...
        patient_mini_file = '/cluster/project8/vyp/JingYu/git/phenopolis_analysis/data/private/hpo/patients_hpo_'+
        ...
        # removing non-coding?
        # Note that even if this is true, it will try to keep non-coding variants
        # close to exons. (5 bases)
        remove_nc = True,
        ...
        cadd_min = 0,
        gnomad_step = 0.00025,
        # not interested in any variants with gnomad allele frequency higher than
        # gnomad_cutoff. 
        gnomad_cutoff = 0.01,
    )
    main(**args)
