'''
get patient map. Overlapping code with patients_variants.py. Need optimising
'''
...
sys.path.append('/cluster/project8/vyp/JingYu/git/phenopolis_analysis/cutoff')
import gnomad_utils
...
if __name__ == '__main__':
    ...
    args = dict(
        # can query genes which will override chrom
